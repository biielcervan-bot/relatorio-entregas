    ...
    try:
        ...
        if df is not None:
            ...
            if df_filtrado.empty:
                ...
                # Funções para extrair a primeira e última hora por agrupamento
                def min_hora(series):
                    valid = series.dropna()
                ...
                # Agrupamento separando por DIA, AGENTE, BASE e CIDADE
                df_resumo = df_filtrado.groupby(['DATA', 'COD_AGENTE_COMERCIAL_STR', 'NOM_BASE_OPERACIONAL_STR', 'NOM_MUNICIPIO_STR']).agg(
                ...
                st.markdown("---")
                st.subheader("📋 Resumo Diário por Agente e Cidade")
